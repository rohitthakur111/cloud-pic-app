...
const SingleLoading = () => {
  return (
    <div className='w-full flex flex-col lg:flex-row gap-8  my-4 pb-8 border-b items-start'>
        <div className="w-full lg:w-1/2 h-96 lg:h-[700px] flex flex-col md:flex-row border shadow rounded-md bg-gray-400 animate-pulse  bg-opacity-50">
        </div>
